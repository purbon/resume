...
and scaling and architecting several Confluent Platform deployment at top companies
in Germany, Spain and Switzerland.

The activities ranges from delivering two days workshops to long term engagements focused
on best practises for deploying the Confluent Streaming platform based on Apache Kafka.
|===
