...
* Disney Research: Revamp of an internal RDF Ontology Storage API PoC to make it production ready, this included a complete code refactoring, development of
test framework, introduction of best practices such as single responsibility, code deduplication, etc.
* Eurecat, Centre Tecnològic de Catalunya: Data architecture consultancy to several external clients, this projects include an assessment of the current situation plus 
